    ...
    public CommandLineRunner loadData(ProductDAO productDAO, UsuarioRepository usuarioRepository, PasswordEncoder passwordEncoder, CategoryRepository categoryRepository) {
        return args -> {
            if (productDAO.count() == 0) {
                ...
                productDAO.save(new Product(true, "Plata de Ley 925 con circonitas engastadas a mano.", "Anillo Apilable 'Luna Nueva'", 45000.0, null, 100, anillos, null));
                productDAO.save(new Product(true, "Baño de Oro 18k con cadena ajustable (40–45 cm).", "Collar Medalla 'Astro Solar'", 89000.0, null, 50, collares, null));
                productDAO.save(new Product(true, "Plata de Ley 925 rodiada antidesgaste de brillo espejo.", "Pulsera Eslabones 'Aura Link'", 65000.0, null, 75, pulseras, null));
                productDAO.save(new Product(true, "Plata 925 con baño de Oro 18k y cierre click seguro.", "Pendientes Aros 'Demi Huggies'", 39000.0, null, 200, pendientes, null));
                productDAO.save(new Product(true, "Oro Vermeil 18k con gema central de topacio blanco natural.", "Anillo Solitario 'Eternity Sparkle'", 120000.0, null, 20, anillos, null));
                productDAO.save(new Product(true, "Perlas cultivadas de agua dulce y broche marinero de plata dorada.", "Gargantilla Perlas 'Riviera'", 75000.0, null, 30, collares, null));
